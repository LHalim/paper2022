...
class wedge_adjoint(object):
    ...
    def objFunc(self, xdict):
        ...
        func1 = functions[0].value * 1/self.ks_scale
        func2 = functions[1].value * 1/self.mass_scale
    ...
    def objGrad(self, xdict, funcs): 
        ...
        grad1 = np.array(grads[0][:]) * 1/self.ks_scale
        grad2 = np.array(grads[1][:]) * 1/self.mass_scale
